    ...
    def parse(self, filename):
        ...
        for lineno, line in enumerate(file):
            ...
            try:
                ...
                continue #hit.referrer = ''
            if hit.referrer == '-':
                continue #hit.referrer = ''
				
            parsed_uri = urlparse.urlparse(match.group('referrer'))

            hit.referrer = ''
            hit.query_string = parsed_uri.query
            hit.full_path = parsed_uri.path
            hit.path = parsed_uri.path
            hit.host = parsed_uri.netloc
