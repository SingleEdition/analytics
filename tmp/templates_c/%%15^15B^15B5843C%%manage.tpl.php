<?php /* Smarty version 2.6.26, created on 2013-03-12 09:57:31
         compiled from /mnt/analytics/plugins/CorePluginsAdmin/templates/manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', '/mnt/analytics/plugins/CorePluginsAdmin/templates/manage.tpl', 5, false),array('modifier', 'nl2br', '/mnt/analytics/plugins/CorePluginsAdmin/templates/manage.tpl', 29, false),)), $this); ?>
...
?>
	<?php if (isset ( $this->_tpl_vars['plugin']['alwaysActivated'] ) && ! $this->_tpl_vars['plugin']['alwaysActivated']): ?>
		<tr <?php if ($this->_tpl_vars['plugin']['activated']): ?>class="highlighted"<?php endif; ?>>
			<td class="name">
