<?php /* Smarty version 2.6.26, created on 2013-02-25 15:26:40
         compiled from /mnt/analytics/plugins/Login/templates/login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', '/mnt/analytics/plugins/Login/templates/login.tpl', 8, false),)), $this); ?>
...
:&nbsp;</strong><?php echo $this->_tpl_vars['invalidHostMessage']; ?>
 ...
 <img style='vertical-align: bottom' src="themes/default/images/help_grey.png" /></a><br/>
...
<form id="login_form" <?php echo $this->_tpl_vars['form_data']['attributes']; ?>
>
	<p>
...
:<br />
	...
	<p class="forgetmenot">
		<label><input name="form_rememberme" type="checkbox" id="login_form_rememberme" value="1" tabindex="90" <?php if ($this->_tpl_vars['form_data']['form_rememberme']['value']): ?>checked="checked" <?php endif; ?>/> <?php echo ((is_array($_tmp='Login_RememberMe')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 </label>
	</p>
	<p>
...
:<br />
	...
	<p>
		<label><?php echo ((is_array($_tmp='Login_PasswordRepeat')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:<br />
