<?php /* Smarty version 2.6.26, created on 2013-03-19 16:10:53
         compiled from MultiSites/templates/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'MultiSites/templates/index.tpl', 13, false),array('modifier', 'replace', 'MultiSites/templates/index.tpl', 13, false),array('modifier', 'translate', 'MultiSites/templates/index.tpl', 22, false),array('function', 'postEvent', 'MultiSites/templates/index.tpl', 28, false),array('function', 'url', 'MultiSites/templates/index.tpl', 85, false),)), $this); ?>
...
<h2><?php echo ((is_array($_tmp='General_AllWebsitesDashboard')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
	...
	<span class='smallTitle' <?php if ($this->_tpl_vars['totalVisitsEvolution']): ?>title="<?php echo ((is_array($_tmp='MultiSites_TotalsEvolutionSummary')) ? $this->_run_mod_handler('translate', true, $_tmp, $this->_tpl_vars['totalVisits'], $this->_tpl_vars['prettyDate'], $this->_tpl_vars['pastTotalVisits'], $this->_tpl_vars['totalVisitsEvolution'], $this->_tpl_vars['pastPeriodPretty']) : smarty_modifier_translate($_tmp, $this->_tpl_vars['totalVisits'], $this->_tpl_vars['prettyDate'], $this->_tpl_vars['pastTotalVisits'], $this->_tpl_vars['totalVisitsEvolution'], $this->_tpl_vars['pastPeriodPretty'])); ?>
"<?php endif; ?>>
