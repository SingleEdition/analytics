...
<td style="width:180px">
    <div id="sparkline_%idsite%" style="width: 100px; margin: auto">
    	<a target="_blank" href="index.php?module=CoreHome&action=index&date=%date%&period=%period%&idSite=%idsite%" title="<?php ob_start(); ?><?php echo ((is_array($_tmp='Dashboard_DashboardOf')) ? $this->_run_mod_handler('translate', true, $_tmp, '%name%') : smarty_modifier_translate($_tmp, '%name%')); ?>
