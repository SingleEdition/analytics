<?php /* Smarty version 2.6.26, created on 2013-02-25 15:35:19
         compiled from /mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'loadJavascriptTranslations', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 2, false),array('function', 'ajaxErrorDiv', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 121, false),array('function', 'ajaxLoadingDiv', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 122, false),array('function', 'url', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 174, false),array('modifier', 'translate', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 5, false),array('modifier', 'inlineHelp', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 6, false),array('modifier', 'escape', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 7, false),array('modifier', 'count', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 128, false),array('modifier', 'replace', '/mnt/analytics/plugins/SitesManager/templates/SitesManager.tpl', 148, false),)), $this); ?>
...
" />
	...
	<table class="entityTable dataTable" id="editSites">
		<thead>
			...
			<th id='exclude-user-agent-header' <?php if (! $this->_tpl_vars['allowSiteSpecificUserAgentExclude']): ?>style="display:none"<?php endif; ?>><?php echo ((is_array($_tmp='SitesManager_ExcludedUserAgents')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</th>
...
<br /><?php endforeach; endif; unset($_from); ?></td>
				<td id="excludedUserAgents" class="editableSite" <?php if (! $this->_tpl_vars['allowSiteSpecificUserAgentExclude']): ?>style="display:none"<?php endif; ?>><?php $_from = $this->_tpl_vars['site']['excluded_user_agents']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ua']):
?><?php echo $this->_tpl_vars['ua']; ?>
<br /><?php endforeach; endif; unset($_from); ?></td>
				<td id="sitesearch" class="editableSite"><?php if ($this->_tpl_vars['site']['sitesearch']): ?><span class='sitesearchActive'><?php echo ((is_array($_tmp='General_Yes')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span><?php else: ?><span class='sitesearchInactive'>-</span><?php endif; ?><span class='sskp' sitesearch_keyword_parameters="<?php echo ((is_array($_tmp=$this->_tpl_vars['site']['sitesearch_keyword_parameters'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
<?php if (! $this->_tpl_vars['isSuperUser']): ?>
<input type="hidden" size="15" id="globalSearchKeywordParameters" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['globalSearchKeywordParameters'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></input>
<input type="hidden" size="15"  id="globalSearchCategoryParameters" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['globalSearchCategoryParameters'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></input>
<?php endif; ?>
...
<br />
	...
	<table style='width:600px' class="adminTable" >
		...
		</td><td><label for="globalExcludedQueryParameters"><?php echo $this->_tpl_vars['excludedQueryParametersHelp']; ?>
</label>
		</td></tr>
		...
		</td><td><label for="globalExcludedUserAgents"><?php echo $this->_tpl_vars['excludedUserAgentsHelp']; ?>
</label>
		</td></tr>
		
		<tr><td>
			<input type="checkbox" id="enableSiteUserAgentExclude" name="enableSiteUserAgentExclude" <?php if ($this->_tpl_vars['allowSiteSpecificUserAgentExclude']): ?>checked="checked"<?php endif; ?>/><label for="enableSiteUserAgentExclude"><?php echo ((is_array($_tmp='SitesManager_EnableSiteSpecificUserAgentExclude')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</label>
		...
		</td><td><?php echo ((is_array($_tmp=((is_array($_tmp='SitesManager_EnableSiteSpecificUserAgentExclude_Help')) ? $this->_run_mod_handler('translate', true, $_tmp, '<a href="#editSites">', '</a>') : smarty_modifier_translate($_tmp, '<a href="#editSites">', '</a>')))) ? $this->_run_mod_handler('inlineHelp', true, $_tmp) : smarty_modifier_inlineHelp($_tmp)); ?>
		...
		<p><?php echo $this->_tpl_vars['sitesearchIntro']; ?>
			...
			<span class="form-description" style='font-size:8pt'><?php echo ((is_array($_tmp='SitesManager_SearchParametersNote')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 ...
 &nbsp;<input type="text" size="15" id="globalSearchKeywordParameters" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['globalSearchKeywordParameters'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></input>
 ...
 <br/>
  ...
  &nbsp;<input type="text" size="15"  id="globalSearchCategoryParameters" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['globalSearchCategoryParameters'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"></input>
