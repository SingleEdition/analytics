<?php /* Smarty version 2.6.26, created on 2013-02-25 15:26:50
         compiled from /mnt/analytics/plugins/Live/templates/lastVisits.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/mnt/analytics/plugins/Live/templates/lastVisits.tpl', 8, false),array('modifier', 'translate', '/mnt/analytics/plugins/Live/templates/lastVisits.tpl', 8, false),array('modifier', 'escape', '/mnt/analytics/plugins/Live/templates/lastVisits.tpl', 11, false),array('modifier', 'money', '/mnt/analytics/plugins/Live/templates/lastVisits.tpl', 48, false),)), $this); ?>
...
: <?php echo ((is_array($_tmp=$this->_tpl_vars['action']['pageTitle'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
 - <?php echo ((is_array($_tmp=$this->_tpl_vars['action']['serverTimePretty'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" />
					<?php else: ?>
						<img class='iconPadding' src="<?php echo $this->_tpl_vars['action']['icon']; ?>
