<?php /* Smarty version 2.6.26, created on 2013-03-19 16:09:25
         compiled from Live/templates/visitorLog.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'Live/templates/visitorLog.tpl', 4, false),array('modifier', 'escape', 'Live/templates/visitorLog.tpl', 47, false),array('modifier', 'capitalize', 'Live/templates/visitorLog.tpl', 72, false),array('modifier', 'truncate', 'Live/templates/visitorLog.tpl', 101, false),array('modifier', 'count', 'Live/templates/visitorLog.tpl', 150, false),array('modifier', 'trim', 'Live/templates/visitorLog.tpl', 173, false),array('modifier', 'money', 'Live/templates/visitorLog.tpl', 192, false),array('modifier', 'unescape', 'Live/templates/visitorLog.tpl', 221, false),array('modifier', 'urldecode', 'Live/templates/visitorLog.tpl', 221, false),array('function', 'cycle', 'Live/templates/visitorLog.tpl', 79, false),)), $this); ?>
...
, Provider <?php echo ((is_array($_tmp=$this->_tpl_vars['visitor']['columns']['provider'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" />
...
, <?php echo $this->_tpl_vars['visitor']['columns']['resolution']; ?>
 (<?php echo $this->_tpl_vars['visitor']['columns']['screenType']; ?>
		...
		<a class="rightLink" href="javascript:broadcast.propagateAjax('module=Live&action=getVisitorLog&period=month&segment=visitorId==<?php echo $this->_tpl_vars['visitor']['columns']['visitorId']; ?>
')">
...
?>
    ...
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['customVariable']):
?><?php ob_start(); ?>customVariableName<?php echo $this->_tpl_vars['id']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('name', ob_get_contents());ob_end_clean(); ?><?php ob_start(); ?>customVariableValue<?php echo $this->_tpl_vars['id']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('value', ob_get_contents());ob_end_clean(); ?>
