...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urlRewriteWithParameters', 'CoreHome/templates/menu.tpl', 4, false),array('modifier', 'substr', 'CoreHome/templates/menu.tpl', 4, false),array('modifier', 'translate', 'CoreHome/templates/menu.tpl', 4, false),array('modifier', 'escape', 'CoreHome/templates/menu.tpl', 8, false),)), $this); ?>
<ul class="nav">
...
' href='#<?php echo ((is_array($_tmp=smarty_modifier_urlRewriteWithParameters($this->_tpl_vars['urlParameters']['_url']))) ? $this->_run_mod_handler('substr', true, $_tmp, 1) : substr($_tmp, 1)); ?>
